const Footer = () => {
	return (
		<div>
			<div className="flex flex-col items-center bg-primary-darkModerateCyan py-14">
				<img className="mb-8" src="/images/logo.svg" />
				<ul className="flex justify-center mb-16 text-sm gap-14 font-barlow">
					<li>
				...
				<ul className="flex items-center justify-center gap-6 text-sm font-barlow text-footer">
					<li>
						<a href="#">
